...
const Invite = ({code, name, rsvp, seatNames, eventsHash, introMessage, domain, pub, translations, lang}) => {
  const t = (key, ctx = {}) => {
  ...
  return (<>
    ...
    <Header t={t} domain={domain} code={code} selected="rsvp" lang={lang} />

    <div className="section">
      <Rsvp name={name} invite={code} rsvp={rsvp} seatNames={seatNames} eventsHash={eventsHash} t={t} pub={pub} />
    </div>
  </>)
}
